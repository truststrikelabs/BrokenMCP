...
FLAG_LABELS = {
    "hr_in_the_index": "hr_in_the_index",
    "ticket_became_policy": "ticket_became_policy",
    "cache_poisoned": "cache_poisoned",
    "other_tenants_secret": "other_tenants_secret",
    "name_collision": "name_collision",
    "onboarding_injection": "onboarding_injection",
}
RUN_ID = ""
FLAGS: dict[str, str] = {}
