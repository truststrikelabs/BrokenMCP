...
from billing import database


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run BrokenMCP Corp and billing_mcp.")
    parser.add_argument("--host", default="127.0.0.1")
    parser.add_argument("--port", type=int, default=8405)
    parser.add_argument("--reset", action="store_true", help="Reset the billing data before starting.")
...
def main() -> None:
    ...
    from billing.mcp_server import reset_demo_state

    reset_demo_state()

    print("BrokenMCP Corp - billing adjustments")
