...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run BrokenMCP Corp and telemetry_mcp.")
    parser.add_argument("--host", default="127.0.0.1")
    parser.add_argument("--port", type=int, default=8407)
    parser.add_argument("--reset", action="store_true", help="Reset the telemetry data before starting.")
...
def main() -> None:
    ...
    from telemetry.mcp_server import reset_demo_state

    reset_demo_state()

    print("BrokenMCP Corp - telemetry platform")
