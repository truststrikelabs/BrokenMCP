...
from telemetry import database, lab
from telemetry.mcp_server import mcp, reset_demo_state
...
async def health(_: Request) -> JSONResponse:
    return JSONResponse({"status": "ok", "service": "telemetry_mcp"})
