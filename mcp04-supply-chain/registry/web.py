...
from registry import database, lab
from registry.mcp_server import mcp, reset_demo_state
...
async def health(_: Request) -> JSONResponse:
    return JSONResponse({"status": "ok", "service": "registry_mcp"})
